...
```
Changelog:
- July 23, 2025. Fixed PDF and Word formatting with structured content display - Resolved paragraph formatting issues in both PDF and Word downloads by implementing proper JSON parsing and structured section generation. Enhanced content formatting to display Summary, Abnormal Values, Recommendations, and Clinical Interpretation as organized sections instead of raw text. Added 3 colorful PDF templates (Professional Blue, Medical Green, Modern Purple) with proper content structure, headers, and template-specific styling. Fixed both jsPDF and DOCX generation to handle analysis data accurately with structured formatting.
- July 23, 2025. Updated Lab Interpreter with comprehensive functional medicine prompts - Implemented advanced functional medicine AI prompts that provide structured analysis with 4 detailed sections: (1) Blood Biomarker Analysis with clinical significance explanations, (2) Disease & Organ System Dysfunction correlation, (3) Branded Supplements & Peptides recommendations from company dataset, (4) Holistic & Actionable health insights. The new prompts emphasize patient-friendly language, biomarker connections, absorption interactions, and red flag identification for medical follow-up.
- July 23, 2025. Dramatically optimized PDF processing speed with ultra-fast parallel processing - Replaced slow sequential page processing with parallel processing of all pages simultaneously. Removed 1-second delays between pages, optimized ImageMagick settings for speed (100 DPI, 60% quality, grayscale), reduced OpenAI token limits, and used "low detail" mode for 3x faster Vision API processing. Performance improvement: 5-10x faster for multi-page PDFs.
- July 19, 2025. Added rich text editor for lab report styling - Implemented comprehensive text editing capabilities with font customization, color controls, alignment options, and formatting tools. Users can now edit analysis results with rich styling features and download professionally formatted PDF and Word documents that preserve all formatting, colors, and design elements. The editor includes toolbar controls for fonts, text formatting, alignment, colors, highlighting, and heading styles.
- July 19, 2025. Implemented company-only product recommendation system - Updated AI analysis to ONLY recommend products from the imported knowledge base. Enhanced system prompts and knowledge base formatting to ensure AI never suggests products outside the company's inventory. This ensures the platform exclusively promotes the company's own peptides, formulas, and supplements with exact dosage instructions from their catalog.
- July 19, 2025. Enhanced knowledge base Excel import to accept any file structure - Updated the system to flexibly handle any Excel file with any number of columns and rows. Improved column detection to automatically categorize data into peptides, supplements, dosages, and additional information. System now captures ALL data from Excel files regardless of structure and organizes it appropriately for AI analysis.
- July 19, 2025. Added collapsible guidelines feature - Added hide/show functionality for knowledge base upload guidelines to save screen space and improve knowledge base viewing experience. Guidelines are collapsed by default with clickable header toggle.
