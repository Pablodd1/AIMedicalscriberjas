  ...
  try {
    ...
    if (!settings) {
      ...
      return res.json({
        ...
        with_patient_prompt: 'Analyze this blood panel report for ${patientName} (ID: ${patientId}). Compare values to functional medicine optimal ranges in the knowledge base. Reference this data against the known values provided. Follow these steps:\n1. Extract & Analyze Blood Biomarkers: Identify all biomarkers, compare with ranges in the knowledge base, and detect deficiencies or imbalances.\n2. Correlate Biomarkers with Disease States & Organ Systems: Cross-reference findings with disease states and organ systems from the knowledge base.\n3. Match Findings with Supplements & Peptides: Suggest primary and secondary peptides, supplements, and formulas from the knowledge base.\n4. Create a structured report with: Blood Panel Summary (a table with values and interpretation), Peptide & Supplement Recommendations (with explanations), Lifestyle & Diet Modifications, and Follow-up Questions.',
        without_patient_prompt: 'Analyze this blood panel report. Compare values to functional medicine optimal ranges in the knowledge base. Reference this data against the known values provided. Follow these steps:\n1. Extract & Analyze Blood Biomarkers: Identify all biomarkers, compare with ranges in the knowledge base, and detect deficiencies or imbalances.\n2. Correlate Biomarkers with Disease States & Organ Systems: Cross-reference findings with disease states and organ systems from the knowledge base.\n3. Match Findings with Supplements & Peptides: Suggest primary and secondary peptides, supplements, and formulas from the knowledge base.\n4. Create a structured report with: Blood Panel Summary (a table with values and interpretation), Peptide & Supplement Recommendations (with explanations), Lifestyle & Diet Modifications, and Follow-up Questions.',
        ...
        withPatientPrompt: 'Analyze this blood panel report for ${patientName} (ID: ${patientId}). Compare values to functional medicine optimal ranges in the knowledge base. Reference this data against the known values provided. Follow these steps:\n1. Extract & Analyze Blood Biomarkers: Identify all biomarkers, compare with ranges in the knowledge base, and detect deficiencies or imbalances.\n2. Correlate Biomarkers with Disease States & Organ Systems: Cross-reference findings with disease states and organ systems from the knowledge base.\n3. Match Findings with Supplements & Peptides: Suggest primary and secondary peptides, supplements, and formulas from the knowledge base.\n4. Create a structured report with: Blood Panel Summary (a table with values and interpretation), Peptide & Supplement Recommendations (with explanations), Lifestyle & Diet Modifications, and Follow-up Questions.',
        withoutPatientPrompt: 'Analyze this blood panel report. Compare values to functional medicine optimal ranges in the knowledge base. Reference this data against the known values provided. Follow these steps:\n1. Extract & Analyze Blood Biomarkers: Identify all biomarkers, compare with ranges in the knowledge base, and detect deficiencies or imbalances.\n2. Correlate Biomarkers with Disease States & Organ Systems: Cross-reference findings with disease states and organ systems from the knowledge base.\n3. Match Findings with Supplements & Peptides: Suggest primary and secondary peptides, supplements, and formulas from the knowledge base.\n4. Create a structured report with: Blood Panel Summary (a table with values and interpretation), Peptide & Supplement Recommendations (with explanations), Lifestyle & Diet Modifications, and Follow-up Questions.'
      });
    }
