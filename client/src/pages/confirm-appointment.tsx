...
export default function ConfirmAppointment() {
  ...
  useEffect(() => {
    const confirmAppointment = async () => {
      ...
      try {
        const res = await fetch("/api/public/confirm-appointment", {
          method: "POST",
        ...
        <CardContent className="space-y-4">
          ...
          {!loading && success && (
            <div className="flex flex-col items-center space-y-4 py-8">
              ...
              <div className="text-center space-y-2">
                <h3 className="text-xl font-semibold text-green-600">Appointment Confirmed!</h3>
              ...
              <p className="text-sm text-muted-foreground text-center">
                You will receive a reminder before your appointment. You can close this page now.
              </p>
            </div>
          )}
          ...
          {!loading && error && (
            <div className="flex flex-col items-center space-y-4 py-8">
              ...
              <div className="text-center space-y-2">
                <h3 className="text-xl font-semibold text-destructive">Unable to Confirm</h3>
